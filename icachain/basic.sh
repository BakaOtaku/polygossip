...
#$BINARY tx intertx register --from $DEMOWALLET_1 --connection-id connection-0 --chain-id $CHAINID_1 --home ./data/$CHAINID_1 --node tcp://localhost:16657 --keyring-backend test -y --gas-prices 100aevmos --gas 500000 --sequence 5
