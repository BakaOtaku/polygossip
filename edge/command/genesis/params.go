...
var (
	...
	basicIBCAddress = types.StringToAddress("d530495B5c95E448E086B494e681D14Ca36d16c0")
)
...
func (p *genesisParams) generateGenesis(enableIBC bool) error {
	if err := p.initGenesisConfig(); err != nil {
		return err
	}

	if p.genesisConfig.Genesis.Alloc[basicIBCAddress] == nil && enableIBC {
		//fmt.Println()
		...
		fmt.Println(err)
		p.genesisConfig.Genesis.Alloc[basicIBCAddress] = predeployAccount
	}
